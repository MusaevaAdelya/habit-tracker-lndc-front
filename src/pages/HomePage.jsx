    ...
    useEffect(() => {
        const fetchRooms = async () => {
            try {
                ...
                const response = await API.get(`/rooms/top-rooms?page=${currentPage}&pageSize=${pageSize}`, {
                    headers: {
                ...
                setTotalResults(response.data.pagination.total); // Get the total results count
